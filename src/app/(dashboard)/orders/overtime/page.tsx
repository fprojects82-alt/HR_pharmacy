...
interface OvertimeRequest {
  ...
  hr_approved: boolean | null; area_manager_approved: boolean | null; control_approved: boolean | null; hr_decision?: string | null
            ...
            <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
              {loading ? (
                ...
                <tr key={r.id} className="hover:bg-slate-50 dark:hover:bg-slate-800/40">
                  ...
                  {isAdmin && (
                    <td className="px-4 py-3"><ApprovalControl table="overtime_requests" id={r.id} status={r.status} hrDecision={r.hr_decision} onDone={load} /></td>
                  )}
                </tr>
              ))}
            </tbody>
