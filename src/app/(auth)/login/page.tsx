      ...
      <div className="w-full max-w-md">
        <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl p-8">
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-slate-900 dark:text-white">نظام نور للموارد البشرية</h1>
            <p className="text-slate-500 dark:text-slate-400 mt-2">تسجيل الدخول إلى حسابك</p>
          </div>
